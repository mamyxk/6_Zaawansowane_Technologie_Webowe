          ...
          <div class="card-body">
            <form @submit.prevent="handleSubmit">
              <div class="form-floating mb-3">
                ...
                <input type="text" id="first-name" placeholder="First Name" v-model="author.firstName"
                  class="form-control" />
              </div>
              <div class="form-floating mb-3">
                <label for="last-name" class="form-label">Last Name:</label>
                <input type="text" id="last-name" placeholder="Last Name" v-model="author.lastName"
                  class="form-control" />
              </div>
